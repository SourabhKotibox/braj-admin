...
function ThemeApplier() {
  ...
  useEffect(() => {
    const name = settings.platformName || "Braj Cinema TV";
...
import AudioListPage from "@/pages/audio-list";
import AudioFormPage from "@/pages/audio-form";
import AudioAlbumsPage from "@/pages/audio-albums";
import AudioArtistsPage from "@/pages/audio-artists";
import AudioArtistsListPage from "@/pages/audio-artists-list";
import AudioArtistFormPage from "@/pages/audio-artist-form";
import AudioAlbumsListPage from "@/pages/audio-albums-list";
...
import AudioBrowsePage from "@/pages/audio-browse";
import VideoMusicBrowsePage from "@/pages/video-music-browse";
import AudioMusicPage from "@/pages/audio-music-page";
import VideoMusicPage from "@/pages/video-music-page";
  ...
  return (
    <Layout>
      ...
      <Switch>
        ...
        <Route path="/audio/new" component={AudioFormPage} />
        <Route path="/audio/:id" component={AudioFormPage} />
        <Route path="/audio" component={AudioListPage} />
        <Route path="/audio-artists/new" component={AudioArtistFormPage} />
        <Route path="/audio-artists/:id/edit" component={AudioArtistFormPage} />
        <Route path="/audio-artists" component={AudioArtistsListPage} />
        <Route path="/audio-albums/new" component={AudioAlbumFormPage} />
        <Route path="/audio-albums/:id/edit" component={AudioAlbumFormPage} />
        <Route path="/audio-albums" component={AudioAlbumsListPage} />
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/audio-browse" component={AudioBrowsePage} />
