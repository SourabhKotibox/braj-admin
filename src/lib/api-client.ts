...
let baseUrl = import.meta.env.VITE_API_URL || "https://brajcinema.tv";
...
export const getAllAudios = async (params?: Record<string, string>) => {
  const search = params ? '?' + new URLSearchParams(params).toString() : '';
  return api(`/audio${search}`);
};

export const getAudioById = async (id: string) => api(`/audio/${id}`);

export const createAudio = async (data: Record<string, any>) => {
  return api('/audio', { method: 'POST', body: JSON.stringify(data) });
};

export const updateAudio = async (id: string, data: Record<string, any>) => {
  return api(`/audio/${id}`, { method: 'PUT', body: JSON.stringify(data) });
};

export const deleteAudio = async (id: string) => {
  return api(`/audio/${id}`, { method: 'DELETE' });
};

export const toggleAudioFeatured = async (id: string) => {
  return api(`/audio/${id}/featured`, { method: 'PATCH' });
};

export const toggleAudioTrending = async (id: string) => {
  return api(`/audio/${id}/trending`, { method: 'PATCH' });
};

export const useGetAllAudios = (params?: Record<string, string>) => {
  return useQuery({ queryKey: ['audios', params], queryFn: () => getAllAudios(params) });
};

export const useGetAudioById = (id: string) => {
  return useQuery({ queryKey: ['audio', id], queryFn: () => getAudioById(id), enabled: !!id });
};

export const useCreateAudio = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: createAudio, onSuccess: () => qc.invalidateQueries({ queryKey: ['audios'] }) });
};

export const useUpdateAudio = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: ({ id, data }: { id: string; data: any }) => updateAudio(id, data), onSuccess: () => qc.invalidateQueries({ queryKey: ['audios'] }) });
};

export const useDeleteAudio = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: deleteAudio, onSuccess: () => qc.invalidateQueries({ queryKey: ['audios'] }) });
};

export const useToggleAudioFeatured = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: toggleAudioFeatured, onSuccess: () => qc.invalidateQueries({ queryKey: ['audios'] }) });
};

export const useToggleAudioTrending = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: toggleAudioTrending, onSuccess: () => qc.invalidateQueries({ queryKey: ['audios'] }) });
};

// ─── Video Music ───────────────────────────────────────────────────────

export const getAllVideoMusics = async (params?: Record<string, string>) => {
  const search = params ? '?' + new URLSearchParams(params).toString() : '';
  return api(`/video-music${search}`);
};

export const getVideoMusicById = async (id: string) => api(`/video-music/${id}`);

export const createVideoMusic = async (data: Record<string, any>) => {
  return api('/video-music', { method: 'POST', body: JSON.stringify(data) });
};

export const updateVideoMusic = async (id: string, data: Record<string, any>) => {
  return api(`/video-music/${id}`, { method: 'PUT', body: JSON.stringify(data) });
};

export const deleteVideoMusic = async (id: string) => {
  return api(`/video-music/${id}`, { method: 'DELETE' });
};

export const toggleVideoMusicFeatured = async (id: string) => {
  return api(`/video-music/${id}/featured`, { method: 'PATCH' });
};

export const toggleVideoMusicTrending = async (id: string) => {
  return api(`/video-music/${id}/trending`, { method: 'PATCH' });
};

export const useGetAllVideoMusics = (params?: Record<string, string>) => {
  return useQuery({ queryKey: ['videoMusics', params], queryFn: () => getAllVideoMusics(params) });
};

export const useGetVideoMusicById = (id: string) => {
  return useQuery({ queryKey: ['videoMusic', id], queryFn: () => getVideoMusicById(id), enabled: !!id });
};

export const useCreateVideoMusic = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: createVideoMusic, onSuccess: () => qc.invalidateQueries({ queryKey: ['videoMusics'] }) });
};

export const useUpdateVideoMusic = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: ({ id, data }: { id: string; data: any }) => updateVideoMusic(id, data), onSuccess: () => qc.invalidateQueries({ queryKey: ['videoMusics'] }) });
};

export const useDeleteVideoMusic = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: deleteVideoMusic, onSuccess: () => qc.invalidateQueries({ queryKey: ['videoMusics'] }) });
};

export const useToggleVideoMusicFeatured = () => {
  const qc = useQueryClient();
  return useMutation({ mutationFn: toggleVideoMusicFeatured, onSuccess: () => qc.invalidateQueries({ queryKey: ['videoMusics'] }) });
};
...
export const getPublicAudioById = async (id: string) => api(`/public/audio/${id}`, { skipAuth: true });

// Get unique artists for audio
export const getPublicAudioArtists = async () => {
  return api(`/public/audio/artists`, { skipAuth: true });
};

// Get unique albums for audio
export const getPublicAudioAlbums = async () => {
  return api(`/public/audio/albums`, { skipAuth: true });
};

// Get audio by artist
export const getPublicAudioByArtist = async (artist: string, params?: Record<string, string>) => {
  const search = params ? '?' + new URLSearchParams(params).toString() : '';
  return api(`/public/audio/artist/${encodeURIComponent(artist)}${search}`, { skipAuth: true });
};

// Get audio by album
export const getPublicAudioByAlbum = async (album: string, params?: Record<string, string>) => {
  const search = params ? '?' + new URLSearchParams(params).toString() : '';
  return api(`/public/audio/album/${encodeURIComponent(album)}${search}`, { skipAuth: true });
};

export const useGetPublicAudios = (params?: Record<string, string>, enabled = true) => {
  return useQuery({ queryKey: ['public-audios', params], queryFn: () => getPublicAudios(params), enabled });
};

export const useGetPublicAudioArtists = () => {
  return useQuery({ queryKey: ['public-audio-artists'], queryFn: getPublicAudioArtists });
};

export const useGetPublicAudioAlbums = () => {
  return useQuery({ queryKey: ['public-audio-albums'], queryFn: getPublicAudioAlbums });
};

export const useGetPublicAudioByArtist = (artist: string, params?: Record<string, string>, enabled = true) => {
  return useQuery({ queryKey: ['public-audio-artist', artist, params], queryFn: () => getPublicAudioByArtist(artist, params), enabled });
};

export const useGetPublicAudioByAlbum = (album: string, params?: Record<string, string>, enabled = true) => {
  return useQuery({ queryKey: ['public-audio-album', album, params], queryFn: () => getPublicAudioByAlbum(album, params), enabled });
};
...
export const getPublicVideoMusicById = async (id: string) => api(`/public/video-music/${id}`, { skipAuth: true });

// Get unique artists for video music
export const getPublicVideoMusicArtists = async () => {
  return api(`/public/video-music/artists`, { skipAuth: true });
};

// Get unique albums for video music
export const getPublicVideoMusicAlbums = async () => {
  return api(`/public/video-music/albums`, { skipAuth: true });
};

// Get video music by artist
export const getPublicVideoMusicByArtist = async (artist: string, params?: Record<string, string>) => {
  const search = params ? '?' + new URLSearchParams(params).toString() : '';
  return api(`/public/video-music/artist/${encodeURIComponent(artist)}${search}`, { skipAuth: true });
};

// Get video music by album
export const getPublicVideoMusicByAlbum = async (album: string, params?: Record<string, string>) => {
  const search = params ? '?' + new URLSearchParams(params).toString() : '';
  return api(`/public/video-music/album/${encodeURIComponent(album)}${search}`, { skipAuth: true });
};

export const useGetPublicVideoMusics = (params?: Record<string, string>, enabled = true) => {
  return useQuery({ queryKey: ['public-videoMusics', params], queryFn: () => getPublicVideoMusics(params), enabled });
};

export const useGetPublicVideoMusicArtists = () => {
  return useQuery({ queryKey: ['public-video-music-artists'], queryFn: getPublicVideoMusicArtists });
};

export const useGetPublicVideoMusicAlbums = () => {
  return useQuery({ queryKey: ['public-video-music-albums'], queryFn: getPublicVideoMusicAlbums });
};

export const useGetPublicVideoMusicByArtist = (artist: string, params?: Record<string, string>, enabled = true) => {
  return useQuery({ queryKey: ['public-video-music-artist', artist, params], queryFn: () => getPublicVideoMusicByArtist(artist, params), enabled });
};

export const useGetPublicVideoMusicByAlbum = (album: string, params?: Record<string, string>, enabled = true) => {
  return useQuery({ queryKey: ['public-video-music-album', album, params], queryFn: () => getPublicVideoMusicByAlbum(album, params), enabled });
};

// ─── Audio Normalization ──────────────────────────────────────────────

export const normalizeAudio = async (audioUrl: string, options?: { targetLoudness?: number; truePeak?: number; loudnessRange?: number }) => {
  return api('/audio/normalize', {
    method: 'POST',
...
export const getRelatedAudios = async (id: string, limit?: number) => {
  const params = new URLSearchParams({ id });
  if (limit) params.set('limit', limit.toString());
  return api(`/public/audio/related?${params.toString()}`, { skipAuth: true });
};

export const getRelatedVideoMusics = async (id: string, limit?: number) => {
  const params = new URLSearchParams({ id });
  if (limit) params.set('limit', limit.toString());
  return api(`/public/video-music/related?${params.toString()}`, { skipAuth: true });
};

export const useGetRelatedAudios = (id: string, limit = 10) => {
  return useQuery({ queryKey: ['related-audios', id, limit], queryFn: () => getRelatedAudios(id, limit), enabled: !!id });
};

export const useGetRelatedVideoMusics = (id: string, limit = 10) => {
  return useQuery({ queryKey: ['related-videoMusics', id, limit], queryFn: () => getRelatedVideoMusics(id, limit), enabled: !!id });
};

// ─── Audio/Video Music Interactions ─────────────────────────────────────

// Toggle Like for Audio/Video Music (public, no auth required)
export const publicLikeAudio = async (id: string) => {
  return api(`/public/audio/${id}/like`, { method: 'POST', skipAuth: true });
};

export const publicLikeVideoMusic = async (id: string) => {
  return api(`/public/video-music/${id}/like`, { method: 'POST', skipAuth: true });
};

export const usePublicLikeAudio = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: publicLikeAudio,
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['public-audios'] }),
  });
};

export const usePublicLikeVideoMusic = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: publicLikeVideoMusic,
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['public-videoMusics'] }),
  });
};

// Share Audio/Video Music (public)
export const publicShareAudio = async (id: string) => {
  return api(`/public/audio/${id}/share`, { method: 'POST', skipAuth: true });
};

export const publicShareVideoMusic = async (id: string) => {
  return api(`/public/video-music/${id}/share`, { method: 'POST', skipAuth: true });
};

export const usePublicShareAudio = () => {
  return useMutation({ mutationFn: publicShareAudio });
};

export const usePublicShareVideoMusic = () => {
  return useMutation({ mutationFn: publicShareVideoMusic });
};

// Download Audio/Video (public - direct download)
...
// Toggle Wishlist for Audio/Video Music
export const toggleAudioWishlist = async (contentId: string, contentType: 'audio' | 'videoMusic') => {
  return api(`/wishlist/${contentId}`, {
    method: 'POST',
    body: JSON.stringify({ contentType }),
  });
};

export const useToggleAudioWishlist = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: ({ contentId, contentType }: { contentId: string; contentType: 'audio' | 'videoMusic' }) =>
      toggleAudioWishlist(contentId, contentType),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['wishlist'] });
    },
  });
...
// Share Audio/Video Music
export const shareAudio = async (contentId: string, contentType: 'audio' | 'videoMusic') => {
  return api(`/share/${contentId}`, {
    method: 'POST',
    body: JSON.stringify({ contentType }),
  });
};

export const useShareAudio = () => {
  return useMutation({
    mutationFn: ({ contentId, contentType }: { contentId: string; contentType: 'audio' | 'videoMusic' }) =>
      shareAudio(contentId, contentType),
  });
};

// Download Audio/Video Music
export const downloadAudio = async (contentId: string, contentType: 'audio' | 'videoMusic', url: string) => {
  return api('/web/download', {
    method: 'POST',
    body: JSON.stringify({ contentId, contentType, url }),
  });
};

export const useDownloadAudio = () => {
  return useMutation({
    mutationFn: ({ contentId, contentType, url }: { contentId: string; contentType: 'audio' | 'videoMusic'; url: string }) =>
      downloadAudio(contentId, contentType, url),
  });
};

// ─── Audio Artists CRUD ────────────────────────────────────────────
export const getAudioArtistsAdmin = async (params?: { page?: number; limit?: number; search?: string }) => {
  const search = params ? '?' + new URLSearchParams(params as any).toString() : '';
  return api(`/audio-artists${search}`);
};

export const getAudioArtistById = async (id: string) => {
  return api(`/audio-artists/item/${id}`);
};

export const createAudioArtist = async (data: FormData) => {
  return api('/audio-artists', { method: 'POST', body: data });
};

export const updateAudioArtist = async (id: string, data: FormData) => {
  return api(`/audio-artists/item/${id}`, { method: 'PUT', body: data });
};

export const deleteAudioArtist = async (id: string) => {
  return api(`/audio-artists/item/${id}`, { method: 'DELETE' });
};

export const bulkDeleteAudioArtists = async (ids: string[]) => {
  return api('/audio-artists/bulk-delete', { method: 'POST', body: JSON.stringify({ ids }) });
};

// ─── Audio Albums CRUD ─────────────────────────────────────────────
export const getAudioAlbumsAdmin = async (params?: { page?: number; limit?: number; search?: string }) => {
  const search = params ? '?' + new URLSearchParams(params as any).toString() : '';
  return api(`/audio-albums${search}`);
};

export const getAudioAlbumById = async (id: string) => {
  return api(`/audio-albums/item/${id}`);
};

export const createAudioAlbum = async (data: FormData) => {
  return api('/audio-albums', { method: 'POST', body: data });
};

export const updateAudioAlbum = async (id: string, data: FormData) => {
  return api(`/audio-albums/item/${id}`, { method: 'PUT', body: data });
};

export const deleteAudioAlbum = async (id: string) => {
  return api(`/audio-albums/item/${id}`, { method: 'DELETE' });
};
...
export const useGetAudioArtistsAdmin = (params?: { page?: number; limit?: number; search?: string }) => {
  return useQuery({ queryKey: ['audio-artists-admin', params], queryFn: () => getAudioArtistsAdmin(params) });
};

export const useGetAudioArtistById = (id: string) => {
  return useQuery({ queryKey: ['audio-artist', id], queryFn: () => getAudioArtistById(id), enabled: !!id });
};

export const useCreateAudioArtist = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: FormData) => createAudioArtist(data),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-artists-admin'] }); }
  });
};

export const useUpdateAudioArtist = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: FormData }) => updateAudioArtist(id, data),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-artists-admin'] }); }
  });
};

export const useDeleteAudioArtist = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (id: string) => deleteAudioArtist(id),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-artists-admin'] }); }
  });
};

export const useBulkDeleteAudioArtists = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (ids: string[]) => bulkDeleteAudioArtists(ids),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-artists-admin'] }); }
  });
};

// ─── React Query Hooks for Albums ──────────────────────────────────
export const useGetAudioAlbumsAdmin = (params?: { page?: number; limit?: number; search?: string }) => {
  return useQuery({ queryKey: ['audio-albums-admin', params], queryFn: () => getAudioAlbumsAdmin(params) });
};

export const useGetAudioAlbumById = (id: string) => {
  return useQuery({ queryKey: ['audio-album', id], queryFn: () => getAudioAlbumById(id), enabled: !!id });
};

export const useCreateAudioAlbum = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: FormData) => createAudioAlbum(data),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-albums-admin'] }); }
  });
};

export const useUpdateAudioAlbum = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: ({ id, data }: { id: string; data: FormData }) => updateAudioAlbum(id, data),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-albums-admin'] }); }
  });
};

export const useDeleteAudioAlbum = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (id: string) => deleteAudioAlbum(id),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-albums-admin'] }); }
  });
};

export const useBulkDeleteAudioAlbums = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (ids: string[]) => bulkDeleteAudioAlbums(ids),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['audio-albums-admin'] }); }
  });
};
