...
const DEFAULT: AppSettings = {
  ...
  faviconUrl: "",
  logoStyle: "fill",
  platformName: "Braj Cinema TV",
  contactNo: "",
  inquiryEmail: "",
  siteDescription: "",
  copyrightText: "© 2026 Braj Cinema TV. All Rights Reserved.",
  facebookUrl: "",
  twitterUrl: "",
  instagramUrl: "",
  youtubeUrl: "",
  ...
  mailUsername: "",
  mailPassword: "",
  mailFrom: "info@brajcinema.tv",
  mailFromName: "Braj Cinema TV",
  // Notifications
  fcmServerKey: "",
  fcmSenderId: "",
  firebaseApiKey: "",
...
const STORAGE_KEY = "brajcinemaSettings";
...
function mapApiData(api: any): AppSettings {
  ...
  return {
    ...
    moduleAudio: api.moduleAudio ?? DEFAULT.moduleAudio,
    moduleVideoMusic: api.moduleVideoMusic ?? DEFAULT.moduleVideoMusic,
