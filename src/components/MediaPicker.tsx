...
import { Upload, Image as ImageIcon, Video, X, Loader2, Search, Check, Music } from "lucide-react";
...
export default function MediaPicker({ open, onClose, onSelect, source, accept = "image/*,video/*" }: MediaPickerProps) {
  ...
  const defaultFileType: FileTypeFilter = (() => {
    if (accept.includes("image/*") && !accept.includes("video/*") && !accept.includes("audio/*")) return "image";
    if (accept.includes("video/*") && !accept.includes("image/*") && !accept.includes("audio/*")) return "video";
    if (accept.includes("audio/*") && !accept.includes("image/*") && !accept.includes("video/*")) return "audio";
    return "all";
  })();
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                {showFileTypeTabs && (
                  <div className="flex items-center bg-muted border border-border rounded-lg p-0.5 shrink-0">
                    {(["all", "image", "video", "audio"] as FileTypeFilter[]).map((t) => (
                      <button
                        key={t}
                      ...
                      >
                        ...
                        {t === "audio" && <Music className="h-3.5 w-3.5" />}
                      ...
                      return (
                        ...
                        >
                          {media.fileType?.startsWith("video") ? (
                            ...
                            <div className="w-full h-full bg-gradient-to-br from-purple-900/50 to-pink-900/50 flex flex-col items-center justify-center gap-1">
