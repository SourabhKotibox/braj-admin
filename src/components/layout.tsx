...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const hasPermission = (permission: string | null): boolean => {
    ...
    // Check module permissions (handle both modulePermissions and permissions)
    const modulePerms = user?.modulePermissions?.[permission as keyof typeof user.modulePermissions] || user?.permissions?.[permission as keyof typeof user.permissions];
