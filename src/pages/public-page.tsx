...
export default function PublicPagePage() {
  ...
  useEffect(() => {
    if (page) {
      document.title = page.metaTitle || `${page.title} | Braj Cinema TV`;
      ...
      metaDesc.setAttribute('content', page.metaDescription || `Read ${page.title} on Braj Cinema TV.`);
      ...
      if (ogDesc) ogDesc.setAttribute('content', page.metaDescription || `Read ${page.title} on Braj Cinema TV.`);

      const twitterTitle = document.querySelector('meta[name="twitter:title"]');
      if (twitterTitle) twitterTitle.setAttribute('content', page.metaTitle || page.title);

      const twitterDesc = document.querySelector('meta[name="twitter:description"]');
      if (twitterDesc) twitterDesc.setAttribute('content', page.metaDescription || `Read ${page.title} on Braj Cinema TV.`);
    }
  }, [page]);
